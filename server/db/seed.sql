...
INSERT INTO tasks (title, description, status, priority, project_id, assignee, sort_order) VALUES
  ('Load Outscraper data for all 50 states', 'Download and import financial advisor data from Outscraper for every US state into Airtable.', 'todo', 'high', 4, 'Kevin', 0),
  ...
  ('Pre-submission AdSense checks', 'Run through the AdSense approval checklist before resubmitting Holistic Vet.', 'backlog', 'high', 1, 'Kevin', 0),
